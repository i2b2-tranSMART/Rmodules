...
<form>
	<table class="subsettable" style="margin: 10px;width:600px; border: 0px none; border-collapse: collapse;">
		...
		<tr>
			...
			<td align="right" style="vertical-align:top;">
				...
				<br/>
				<br/>
				<input type="checkbox" id="chkAssumeNonEvent"
				       title="Non Event Checkbox"/> Check this box to group together all subjects without a node specified above.
			</td>
			<td align="right" style="vertical-align:top;">
				<input style="font: 9pt tahoma;" type="button"
	...
	<table class="subsettable" style="margin: 10px; width: 90%; border: 0px none; border-collapse: collapse;">
		<tr>
			<td>
				<span class='AnalysisHeader'>Binning&nbsp;&nbsp;&nbsp;<input id="BinningToggle" type="button" value="Enable"
				                                                             onClick="toggleBinningForest();"/></span>
			</td>
		</tr>
		<tr>
			<td>
