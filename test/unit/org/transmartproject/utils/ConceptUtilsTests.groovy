...
class ConceptUtilsTests {
	...
	void testShortestUniqueTailsNormalization() {
		List<String> actualResult = ConceptUtils.shortestUniqueTails(['C',])

		assertThat actualResult, equalTo(['\\C\\',])
	}

	@Test
	void testShortestUniqueTailsForSingleConcept() {
		List<String> actualResult = ConceptUtils.shortestUniqueTails(['\\A\\B\\C\\',])
