...
class OptionalBinningColumnConfiguratorTests extends AbstractJobsIntegrationTest {
	...
	void testClinicalDataContinuousManualBinning() {
		...
		List<QueryResult> queryResults = mockQueryResults()
	...
	void testClinicalDataCategoricalBinning() {
		...
		List<String> valuesForColumns = (1..3).collect { 'value for col' + it }
